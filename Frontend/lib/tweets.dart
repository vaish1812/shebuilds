class Tweets {
  List<Tweet> _tweets = [
    Tweet(
      ...
      'Period',
      '@periodmovement',
      'We loved 2022 ❤ Over 140 new chapters working to advance menstrual  equity in their schools and communities! #EndPeriodPoverty',
      '',
      100,
      20,
      50,
    ...
    Tweet(
      ...
      'LuvUr MCups',
      '@LuvMCup',
      'instant way to start saving money is switching to menstrual cups!! \n #luvurbodymenstrualcups #menstrualcups #period #saving #MONEY',
      'https://health.clevelandclinic.org/wp-content/uploads/sites/3/2021/05/wmnCalendarMenstrual-1205354644_770x553.jpg',
      100,
      20,
      50,
    ),
